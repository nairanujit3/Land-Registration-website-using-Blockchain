            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    // Text(
                    //     '${userInfo[1].toString()}'), // Display the buyer's name
                    Text(
                        '${data[2].toString()}'), // Display the buyer's address
                  ],
                ),
                flex: 5,
              ),
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            image: const DecorationImage(
              image:
                  AssetImage('assets/3.jpeg'), // Replace with your image path
              fit: BoxFit.cover,
            ),
            color: Color.fromARGB(255, 247, 220, 15), // Background color
                  ...
                  child: TextFormField(
                    ...
                    decoration: const InputDecoration(
                      ...
                      labelStyle: TextStyle(
                        color: Color.fromARGB(255, 244, 183,
                            28), // Set the label text color to red
                      ),
                    ),
                  ),
                ),
